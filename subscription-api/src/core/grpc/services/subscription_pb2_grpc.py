...
import grpc
from src.core.grpc.models import subscription_pb2 as subscription__pb2
...
class SubscriptionManagerStub(object):
...
class SubscriptionManagerServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_SubscriptionManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "SubscriptionManager", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("SubscriptionManager", rpc_method_handlers)
